...
const r = null, {min: n, max: o, abs: s, floor: i} = Math, l = (e, t, r) => n(r, o(t, e)), c = e => [ ...e ].sort(((e, t) => e - t)), u = "function" == typeof queueMicrotask ? queueMicrotask : e => {
...
}, S = e => e.documentElement, $ = e => e.ownerDocument, b = e => e.defaultView, x = /*#__PURE__*/ f((() => !!/iP(hone|od|ad)/.test(navigator.userAgent) || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 0)), z = /*#__PURE__*/ f((() => "scrollBehavior" in S(document).style)), w = (e, t = 40, i = 0, l, u = !1) => {
    let a = !!i, f = 1, S = 0, $ = 0, b = 0, z = 0, w = 0, y = 0, _ = 0, I = 0, k = r, T = [ 0, a ? o(i - 1, 0) : -1 ], M = 0, O = !1;
    const R = ((e, t, r) => ({
        i: t,
        ...
        l: -1,
        h: d([], e + 1)
    }))(e, l ? l[1] : t, l && l[0]), q = new Set, J = () => b - $, B = () => J() + w + z, C = (e, t) => ((e, t, r, o) => {
        if (o = n(o, e.u - 1), v(e, o) <= t) {
            const n = p(e, r, o);
            return [ p(e, t, o, n), n ];
        }
        {
            const n = p(e, t, void 0, o);
            return [ n, p(e, r, n) ];
        }
    })(R, e, t, T[0]), E = () => v(R, R.u), H = (e, t) => {
        const r = v(R, e) - w;
        return t ? E() - r - L(e) : r;
    ...
    return {
        ...
        H: (e, t) => {
            ...
            switch (e) {
              case 1:
                {
                    ...
                    y = 0;
                    const r = t - b, n = s(r);
                    e && n < s(e) + 1 || 0 !== I || (_ = r < 0 ? 2 : 1), a && (a = !1), b = t, l = 4;
                    const o = J();
                    o >= -S && o <= E() && (l += 1, i = n > S);
                    break;
                }
              ...
              case 3:
                {
                    ...
                    if (!e.length) break;
                    W(e.reduce(((e, [t, r]) => ((2 === I || (k && 1 === I ? t < k[0] : H(t + (0 === _ && 0 === I ? 1 : 0)) < J())) && (e += r - L(t)), 
                    e)), 0));
                    for (const [t, r] of e) {
                    ...
                    u && S && M > S && (W(((e, t) => {
                        ...
                        const s = c(n), i = s.length, l = i / 2 | 0, u = i % 2 == 0 ? (s[l - 1] + s[l]) / 2 : s[l], a = e.i;
                        return ((e.i = u) - a) * o(t - r, 0);
                    })(R, p(R, B()))), u = !1), l = 3, i = !0;
                    break;
                }
              ...
              case 5:
                t[1] ? (W(m(R, t[0], !0)), I = 2, l = 1) : (m(R, t[0]), l = 1);
                break;
            ...
            l && (f = 1 + (2147483647 & f), n && w && (z += w, w = 0), q.forEach((([e, t]) => {
                l & e && t(i);
            })));
        }
    };
    ...
    return t.addEventListener("scroll", h), t.addEventListener("wheel", v, {
        passive: !0
        ...
        P: () => {
            t.removeEventListener("scroll", h), t.removeEventListener("wheel", v), t.removeEventListener("touchstart", p), 
    ...
    let s;
    const {itemSize: i, horizontal: u = !1, cache: f} = n;
    n = t.mergeProps({
        as: "div"
    }, n);
    const d = w(n.data.length, i, void 0, f, !i), g = ((e, t) => {
        let n;
        const o = t ? "width" : "height", s = new WeakMap, i = T((t => {
            const i = [];
            for (const {target: l, contentRect: c} of t) if (l.offsetParent) if (l === n) e.H(4, c[o]); else {
                const e = s.get(l);
                e != r && i.push([ e, c[o] ]);
            }
            i.length && e.H(3, i);
        ...
        let r, n, o = a(), s = !1;
        const i = t ? "scrollLeft" : "scrollTop", c = t ? "overflowX" : "overflowY", [u, f] = k(e, (() => o[0]), ((e, n) => {
    ...
    })(d, u), [v, p] = t.createSignal(d.p());
    d.C(1, (() => {
        p(d.p());
    })), d.C(4, (() => {
        var e;
        null === (e = n.onScroll) || void 0 === e || e.call(n, d.M());
    })), d.C(8, (() => {
        var e;
        null === (e = n.onScrollEnd) || void 0 === e || e.call(n);
    }));
    const m = t.createMemo((e => {
        v();
        const t = d.S(n.bufferSize);
        return e && O(e, t) ? e : t;
    })), S = t.createMemo((() => v() && d.O())), $ = t.createMemo((() => v() && d.J())), b = t.createMemo((() => v() && h.ee()));
    t.onMount((() => {
        n.ref && n.ref({
            get cache() {
                return d.m();
        ...
        g.G(r), h.Z(e, r), t.onCleanup((() => {
            n.ref && n.ref(), d.v(), g.v(), h.v();
        }));
    })), t.createComputed(t.on((() => n.startMargin || 0), (e => {
        e !== d.q() && d.H(6, e);
    }))), t.createEffect(t.on(v, (() => {
        h.oe();
    })));
    ...
    return e.createComponent(e.Dynamic, {
        ...
        get children() {
            return e.createComponent(t.For, {
                ...
                children: (r, o) => ((r, o) => {
                    const s = t.createMemo((() => (v(), d.I(o(), b())))), i = t.createMemo((() => (v(), 
                    d._(o())))), l = t.createMemo((() => t.untrack((() => n.children(r, o)))));
...
exports.VList = r => {
    ...
    let o;
    const {ref: s, data: i, children: c, itemSize: f, shift: d, horizontal: g = !1, cache: h, onScrollEnd: v} = n, p = w(n.data.length, f, void 0, h, !f), m = ((e, t) => {
        ...
        return {
            G(t) {
                ...
                r.addEventListener("resize", n), u(n), l = () => {
        ...
        let r, n, o = a(), s = !1;
        const i = t ? "left" : "top", [c] = k(e, (() => o[0]), ((e, t) => {
            e = _(e, s);
            const n = b($(r));
            t ? n.scroll({
                [i]: e,
            ...
            const i = n ? "offsetLeft" : "offsetTop", l = o + (n && s ? r.innerWidth - e[i] - e.offsetWidth : e[i]), c = e.offsetParent;
            return e !== t && c ? u(c, t, r, n, l) : l;
        };
        return {
            Z(l) {
                r = l;
                const c = t ? "scrollX" : "scrollY", a = $(l), f = b(a);
                t && (s = "rtl" === getComputedStyle(S(a)).direction), n = I(e, f, t, (() => _(f[c], s)), ((t, r) => {
                    r ? f.scroll({
                        [i]: _(e.M() + t, s)
                    }) : f.scrollBy({
                        [i]: _(t, s)
                    });
                }), (() => u(l, a.body, f, t))), o[1](!0);
            },
            v() {
                n && n.P(), r = void 0, o[1](!1), o = a();
            },
            ee: () => s,
            oe: () => {
                n && n.W();
            ...
            ne(n, {align: o, smooth: s, offset: i = 0} = {}) {
                ...
                const a = $(r), f = b(a), d = S(a), g = () => e.R() - (t ? d.clientWidth : d.clientHeight);
                c((() => i + u(r, a.body, f, t) + e.I(n) + ("end" === o ? e.k(n) - (e.R() - g()) : "center" === o ? (e.k(n) - (e.R() - g())) / 2 : 0)), s);
            }
        };
    })(p, g), [z, y] = t.createSignal(p.p());
    p.C(1, (() => {
        y(p.p());
    })), p.C(4, (() => {
        var e;
        null === (e = n.onScroll) || void 0 === e || e.call(n);
    })), p.C(8, (() => {
        var e;
        null === (e = n.onScrollEnd) || void 0 === e || e.call(n);
    }));
    const R = t.createMemo((e => {
        z();
        const t = p.S(n.bufferSize);
        return e && O(e, t) ? e : t;
    })), q = t.createMemo((() => z() && p.O())), B = t.createMemo((() => z() && p.J())), C = t.createMemo((() => z() && x.ee()));
    t.onMount((() => {
        n.ref && n.ref({
            get cache() {
                return p.m();
    ...
    e.insert(H, e.createComponent(t.For, {
        ...
        children: (r, o) => {
            const s = t.createMemo((() => R()[0] + o())), i = t.createMemo((() => (z(), p.I(s(), C())))), l = t.createMemo((() => (z(), 
            p._(s())))), c = t.createMemo((() => t.untrack((() => n.children(r, s)))));
            return e.createComponent(M, {
                get Y() {
                    return s();
                },
