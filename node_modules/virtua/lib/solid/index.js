import { createComponent as e, Dynamic as t, template as r, spread as n, mergeProps as o, insert as s, use as i, setStyleProperty as c, effect as l } from "solid-js/web";

import { mergeProps as u, createEffect as a, createMemo as f, onCleanup as d, createSignal as g, onMount as h, createComputed as v, on as p, untrack as m, For as S, splitProps as $ } from "solid-js";
...
const b = null, {min: z, max: w, abs: x, floor: y} = Math, _ = (e, t, r) => z(r, w(t, e)), I = e => [ ...e ].sort(((e, t) => e - t)), k = "function" == typeof queueMicrotask ? queueMicrotask : e => {
    ...
    let s = !!r, i = 1, c = 0, l = 0, u = 0, a = 0, f = 0, d = 0, g = 0, h = 0, v = b, p = [ 0, s ? w(r - 1, 0) : -1 ], m = 0, S = !1;
    const $ = ((e, t, r) => ({
        i: t,
        ...
        l: -1,
        h: O([], e + 1)
    }))(e, n ? n[1] : t, n && n[0]), y = new Set, _ = () => u - l, k = () => _() + f + a, T = (e, t) => ((e, t, r, n) => {
    ...
    return {
        ...
        S: (e = 200) => {
            ...
            if (d) [t, r] = p; else {
                let n = w(0, k()), s = n + c;
                o || (e = w(0, e), 1 !== g && (n -= e), 2 !== g && (s += e)), [t, r] = p = T(w(0, n), w(0, s)), 
                v && (t = z(t, v[0]), r = w(r, v[1]));
            }
        ...
        H: (e, t) => {
            ...
            switch (e) {
              case 1:
                {
                    ...
                    d = 0;
                    const r = t - u, o = x(r);
                    e && o < x(e) + 1 || 0 !== h || (g = r < 0 ? 2 : 1), s && (s = !1), u = t, p = 4;
                    const i = _();
                    i >= -c && i <= M() && (p += 1, n = o > c);
                    break;
                }
              ...
              case 3:
                {
                    ...
                    if (!e.length) break;
                    j(e.reduce(((e, [t, r]) => ((2 === h || (v && 1 === h ? t < v[0] : E(t + (0 === g && 0 === h ? 1 : 0)) < _())) && (e += r - H(t)), 
                    e)), 0));
                    for (const [t, r] of e) {
                        const e = H(t), n = J($, t, r);
                        o && (m += n ? r : r - e);
              ...
              case 5:
                t[1] ? (j(C($, t[0], !0)), h = 2, p = 1) : (C($, t[0]), p = 1);
                break;
            ...
            p && (i = 1 + (2147483647 & i), r && f && (a += f, f = 0), y.forEach((([e, t]) => {
                p & e && t(n);
            })));
        }
    };
    ...
    return t.addEventListener("scroll", g), t.addEventListener("wheel", h, {
        ...
        W: () => {
            t.removeEventListener("scroll", g), t.removeEventListener("wheel", h), t.removeEventListener("touchstart", v), 
            t.removeEventListener("touchend", p), d.L();
        },
        j: () => {
            const [t, r] = e.B();
            t && (o(t, r, f), f = !1, r && e.R() > e.P() && e.H(1, n()));
        }
    };
}, Y = (e, t, r) => {
    let n;
    ...
    const c = q(r.data.length, o, void 0, i, !o), l = ((e, t) => {
        ...
        return {
            Z(l, a) {
                r = a, t && (s = "rtl" === getComputedStyle(a).direction), n = X(e, a, t, (() => V(a[i], s)), ((t, r, n) => {
                    if (n) {
    ...
    h((() => {
        ...
        l.G(t), $.Z(e, t), d((() => {
            r.ref && r.ref(), c.v(), l.v(), $.v();
        }));
    })), v(p((() => r.startMargin || 0), (e => {
        e !== c.J() && c.H(6, e);
    }))), a(p(z, (() => {
        $.oe();
    })));
    ...
    return e(t, {
        ...
        get children() {
            return e(S, {
                ...
                children: (t, n) => ((t, n) => {
                    const o = f((() => (z(), c.I(n(), O())))), i = f((() => (z(), c._(n())))), u = f((() => m((() => r.children(t, n)))));
                    return e(U, {
                        get V() {
                            return r.item;
                        },
...
var G = /*#__PURE__*/ r("<div>");

const K = t => {
    const [r, i] = $(t, [ "ref", "data", "children", "bufferSize", "itemSize", "shift", "horizontal", "keepMounted", "cache", "item", "onScroll", "onScrollEnd", "style" ]);
    return c = G(), n(c, o(i, {
        get style() {
            return {
                display: r.horizontal ? "inline-block" : "block",
                [r.horizontal ? "overflow-x" : "overflow-y"]: "auto",
                contain: "strict",
                width: "100%",
                height: "100%",
                ...r.style
...
var Q = /*#__PURE__*/ r("<div style=overflow-anchor:none>");

const Z = t => {
    let r;
    const {ref: n, data: o, children: u, itemSize: v, shift: $, horizontal: z = !1, cache: w, onScrollEnd: x} = t, y = q(t.data.length, v, void 0, w, !v), I = ((e, t) => {
        ...
        return {
            Z(c) {
                r = c;
                const u = t ? "scrollX" : "scrollY", a = H(c), f = L(a);
                t && (s = "rtl" === getComputedStyle(E(a)).direction), n = X(e, f, t, (() => V(f[u], s)), ((t, r) => {
                    r ? f.scroll({
                        [i]: V(e.M() + t, s)
                    }) : f.scrollBy({
                        [i]: V(t, s)
                    });
                }), (() => l(c, a.body, f, t))), o[1](!0);
            },
            v() {
            ...
            ne(n, {align: o, smooth: s, offset: i = 0} = {}) {
                ...
                const u = H(r), a = L(u), f = E(u), d = () => e.R() - (t ? f.clientWidth : f.clientHeight);
                c((() => i + l(r, u.body, a, t) + e.I(n) + ("end" === o ? e.k(n) - (e.R() - d()) : "center" === o ? (e.k(n) - (e.R() - d())) / 2 : 0)), s);
            }
        };
    })(y, z), [O, R] = g(y.p());
    y.C(1, (() => {
    ...
    const J = f((e => {
        ...
        return e && A(e, r) ? e : r;
    })), P = f((() => O() && y.O())), B = f((() => O() && y.P())), C = f((() => O() && M.ee()));
    h((() => {
        t.ref && t.ref({
            get cache() {
                return y.m();
    ...
    c(j, "flex", "none"), c(j, "position", "relative"), s(j, e(S, {
        get each() {
            return W();
        },
        children: (r, n) => {
            const o = f((() => J()[0] + n())), s = f((() => (O(), y.I(o(), C())))), i = f((() => (O(), 
            y._(o())))), c = f((() => m((() => t.children(r, o)))));
            return e(U, {
                get Y() {
                    return o();
                },
