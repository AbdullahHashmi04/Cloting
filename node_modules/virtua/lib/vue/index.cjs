...
const t = null, {min: r, max: o, abs: n, floor: s} = Math, i = (e, t, n) => r(n, o(t, e)), l = e => [ ...e ].sort(((e, t) => e - t)), c = "function" == typeof queueMicrotask ? queueMicrotask : e => {
...
}, b = e => e.documentElement, v = e => e.ownerDocument, g = e => e.defaultView, y = /*#__PURE__*/ u((() => !!/iP(hone|od|ad)/.test(navigator.userAgent) || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 0)), S = /*#__PURE__*/ u((() => "scrollBehavior" in b(document).style)), z = (e, s = 40, i = 0, c, a = !1) => {
    let u = !!i, b = 1, v = 0, g = 0, S = 0, z = 0, x = 0, $ = 0, w = 0, I = 0, O = t, k = [ 0, u ? o(i - 1, 0) : -1 ], j = 0, N = !1;
    const q = ((e, t, n) => ({
        o: t,
        ...
        i: -1,
        u: f([], e + 1)
    }))(e, c ? c[1] : s, c && c[0]), B = new Set, T = () => S - g, M = () => T() + x + z, E = (e, t) => ((e, t, o, n) => {
              ...
              case 3:
                {
                    ...
                    if (!e.length) break;
                    H(e.reduce(((e, [t, r]) => ((2 === I || (O && 1 === I ? t < O[0] : R(t + (0 === w && 0 === I ? 1 : 0)) < T())) && (e += r - A(t)), 
                    e)), 0));
                    for (const [t, r] of e) {
    ...
    return {
        F(r) {
            (t || (t = new (g(v(r)).ResizeObserver)(e))).observe(r);
        },
        J(e) {
            t.unobserve(e);
        },
    ...
    setup(t) {
        ...
        return e.watch((() => r.value && t.D), ((e, o, n) => {
            ...
            const {X: i, U: l, G: c, Z: a} = t, u = n.value, {style: f, ...d} = null !== (s = t.ee) && void 0 !== s ? s : {}, p = {
                ...
                position: u && c ? void 0 : "absolute",
                [l ? "height" : "width"]: "100%",
                [l ? "top" : "left"]: "0px",
                [l ? "left" : "top"]: o.value + "px",
                visibility: !u || c ? void 0 : "hidden",
                ...f
            };
            return l && (p.display = "inline-flex"), e.createVNode(a, e.mergeProps({
                ref: r,
                style: p
            }, d), "function" == typeof (m = i) || "[object Object]" === Object.prototype.toString.call(m) && !e.isVNode(m) ? i : {
                default: () => [ i ],
                _: 2
            }, 16, [ "style" ]);
            var m;
    ...
    setup(r, {emit: n, expose: s, slots: c}) {
        ...
        const b = e.computed((e => {
            ...
            return e && N(e, t) ? e : t;
        })), v = e.computed((() => _.value && p.q())), g = e.computed((() => _.value && p.M()));
        return e.onMounted((() => {
            u = !1;
            ...
            const t = r.as, o = r.item, n = g.value, s = h.ne(), i = [], a = t => {
                var n;
                const i = c.default({
                    item: r.data[t],
                    index: t
                ...
                return e.createVNode(k, {
                    ...
                    G: u,
                    Z: o,
                    ee: null === (n = r.itemProps) || void 0 === n ? void 0 : n.call(r, {
                        item: r.data[t],
                        index: t
                    })
            ...
            return e.createVNode(t, {
                ...
                style: {
                    ...
                    width: f ? n + "px" : "100%",
                    height: f ? "100%" : n + "px",
                    pointerEvents: v.value ? "none" : void 0
                }
    ...
    setup(r, {emit: o, slots: n, expose: s}) {
        const l = r.horizontal, u = e.ref(), f = z(r.data.length, r.itemSize, void 0, r.cache, !r.itemSize), d = ((e, r) => {
            ...
            return {
                oe(i) {
                    r = i;
                    const c = t ? "scrollX" : "scrollY", a = v(i), f = g(a);
                ...
                le(o, {align: n, smooth: s, offset: l = 0} = {}) {
                    ...
                    const a = v(r), f = g(a), d = b(a), p = () => e.B() - (t ? d.clientWidth : d.clientHeight);
