...
const a = null, {min: u, max: f, abs: d, floor: p} = Math, m = (e, t, r) => u(r, f(t, e)), h = e => [ ...e ].sort(((e, t) => e - t)), _ = "function" == typeof queueMicrotask ? queueMicrotask : e => {
    ...
    const o = t - e.l;
    return e.i = r ? -1 : u(t - 1, e.i), e.l = t, o > 0 ? (g(e.u, o), g(e.t, o, r), 
    e.o * o) : (e.u.splice(o), (r ? e.t.splice(0, -o) : e.t.splice(o)).reduce(((t, r) => t - (-1 === r ? e.o : r)), 0));
}, w = e => e.documentElement, I = e => e.ownerDocument, O = e => e.defaultView, k = /*#__PURE__*/ v((() => !!/iP(hone|od|ad)/.test(navigator.userAgent) || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 0)), j = /*#__PURE__*/ v((() => "scrollBehavior" in w(document).style)), N = (e, t = 40, r = 0, o, n = !1) => {
    let s = !!r, i = 1, l = 0, c = 0, p = 0, m = 0, _ = 0, b = 0, v = 0, w = 0, I = a, O = [ 0, s ? f(r - 1, 0) : -1 ], j = 0, N = !1;
    const B = ((e, t, r) => ({
        o: t,
        t: r ? g(r.slice(0, u(e, r.length)), f(0, e - r.length)) : g([], e),
        l: e,
        i: -1,
        u: g([], e + 1)
    ...
    return {
        ...
        v: (e = 200) => {
            ...
            if (b) [t, r] = O; else {
                let o = f(0, M()), s = o + l;
                n || (e = f(0, e), 1 !== v && (o -= e), 2 !== v && (s += e)), [t, r] = O = E(f(0, o), f(0, s)), 
              ...
              case 1:
                {
                    ...
                    b = 0;
                    const r = t - p, n = d(r);
                    e && n < d(e) + 1 || 0 !== w || (v = r < 0 ? 2 : 1), s && (s = !1), p = t, u = 4;
                    const i = q();
                    i >= -l && i <= P() && (u += 1, o = n > l);
                    break;
                }
              ...
              case 3:
                {
                    ...
                    if (!e.length) break;
                    H(e.reduce(((e, [t, r]) => ((2 === w || (I && 1 === w ? t < I[0] : R(t + (0 === v && 0 === w ? 1 : 0)) < q())) && (e += r - A(t)), 
                    e)), 0));
                    for (const [t, r] of e) {
    ...
    setup(e) {
        ...
        return o((() => l.value && e.D), ((t, r, o) => {
            ...
            var t;
            const {X: r, U: o, G: u, Z: f} = e, d = a.value, {style: p, ...m} = null !== (t = e.ee) && void 0 !== t ? t : {}, h = {
                contain: "layout style",
                position: d && u ? void 0 : "absolute",
                [o ? "height" : "width"]: "100%",
                [o ? "top" : "left"]: "0px",
                [o ? "left" : "top"]: c.value + "px",
                visibility: !d || u ? void 0 : "hidden",
                ...p
            };
            return o && (h.display = "inline-flex"), n(f, s({
                ref: l,
                style: h
            }, m), "function" == typeof (_ = r) || "[object Object]" === Object.prototype.toString.call(_) && !i(_) ? r : {
                default: () => [ r ],
                _: 2
            }, 16, [ "style" ]);
            var _;
    ...
    setup(e, {emit: s, expose: u, slots: d}) {
        let p = !!e.ssrCount;
        const _ = e.horizontal, v = t(), g = N(e.data.length, e.itemSize, e.ssrCount, e.cache, !e.itemSize), y = ((e, t) => {
            let r;
        ...
        const x = r((t => {
            z.value;
            const r = g.v(e.bufferSize);
            return t && A(t, r) ? t : r;
        })), $ = r((() => z.value && g.B())), w = r((() => z.value && g.M()));
        return l((() => {
            p = !1;
            const t = v.value, r = requestAnimationFrame((() => {
                const r = e => {
                    y.te(e), S.oe(t, e);
                };
            ...
            const t = e.as, r = e.item, o = w.value, s = S.ne(), l = [], c = t => {
                ...
                return n(P, {
                    ...
                    G: p,
                    Z: r,
                    ee: null === (o = e.itemProps) || void 0 === o ? void 0 : o.call(e, {
                        item: e.data[t],
                        index: t
                    })
    ...
    setup(e, {emit: s, slots: u, expose: f}) {
        const d = e.horizontal, p = t(), h = N(e.data.length, e.itemSize, void 0, e.cache, !e.itemSize), v = ((e, t) => {
        ...
        return l((() => {
            ...
            const t = e.as, r = e.item, o = x.value, s = g.ne(), l = [];
