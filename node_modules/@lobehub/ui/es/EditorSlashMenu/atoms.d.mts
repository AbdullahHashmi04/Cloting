...
declare const EditorSlashMenuPortal: FC<EditorSlashMenuPortalProps>;
...
declare const EditorSlashMenuPositioner: {
  ({
    ...
    sideOffset,
    ...rest
  }: EditorSlashMenuPositionerProps): react_jsx_runtime35.JSX.Element;
  displayName: string;
};
...
declare const EditorSlashMenuPopup: {
  ({
    ...
    initialFocus,
    ...rest
  }: EditorSlashMenuPopupProps): react_jsx_runtime35.JSX.Element;
  displayName: string;
};
...
declare const EditorSlashMenuItem: {
  ({
    ...
    danger,
    ...rest
  }: EditorSlashMenuItemProps): react_jsx_runtime35.JSX.Element;
  displayName: string;
};
...
declare const EditorSlashMenuGroupLabel: {
  ({
    className,
    ...rest
  }: EditorSlashMenuGroupLabelProps): react_jsx_runtime35.JSX.Element;
  displayName: string;
};
...
declare const EditorSlashMenuEmpty: {
  ({
    className,
    ...rest
  }: EditorSlashMenuEmptyProps): react_jsx_runtime35.JSX.Element;
  displayName: string;
};
...
declare const EditorSlashMenuItemContent: {
  ({
    className,
    ...rest
  }: EditorSlashMenuItemContentProps): react_jsx_runtime35.JSX.Element;
  displayName: string;
};
...
declare const EditorSlashMenuItemIcon: {
  ({
    className,
    ...rest
  }: EditorSlashMenuItemIconProps): react_jsx_runtime35.JSX.Element;
  displayName: string;
};
...
declare const EditorSlashMenuItemLabel: {
  ({
    className,
    ...rest
  }: EditorSlashMenuItemLabelProps): react_jsx_runtime35.JSX.Element;
  displayName: string;
};
...
declare const EditorSlashMenuItemExtra: {
  ({
    className,
    ...rest
  }: EditorSlashMenuItemExtraProps): react_jsx_runtime35.JSX.Element;
  displayName: string;
};
...
declare const EditorSlashMenuHiddenInput: {
  ({
    className,
    ...rest
  }: EditorSlashMenuHiddenInputProps): react_jsx_runtime35.JSX.Element;
  displayName: string;
};
//#endregion
