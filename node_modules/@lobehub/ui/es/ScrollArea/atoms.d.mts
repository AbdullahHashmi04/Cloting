...
declare const ScrollAreaRoot: {
  ({
    className,
    ...rest
  }: ScrollAreaRootProps): react_jsx_runtime46.JSX.Element;
  displayName: string;
};
declare const ScrollAreaViewport: {
  ({
    ...
    scrollFade,
    ...rest
  }: ScrollAreaViewportProps): react_jsx_runtime46.JSX.Element;
  displayName: string;
};
declare const ScrollAreaContent: {
  ({
    className,
    ...rest
  }: ScrollAreaContentProps): react_jsx_runtime46.JSX.Element;
  displayName: string;
};
declare const ScrollAreaScrollbar: {
  ({
    className,
    ...rest
  }: ScrollAreaScrollbarProps): react_jsx_runtime46.JSX.Element;
  displayName: string;
};
declare const ScrollAreaThumb: {
  ({
    className,
    ...rest
  }: ScrollAreaThumbProps): react_jsx_runtime46.JSX.Element;
  displayName: string;
};
declare const ScrollAreaCorner: {
  ({
    className,
    ...rest
  }: ScrollAreaCornerProps): react_jsx_runtime46.JSX.Element;
  displayName: string;
};
//#endregion
