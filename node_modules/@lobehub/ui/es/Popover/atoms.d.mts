...
declare const PopoverTriggerElement: {
  ({
    ...
    ref: refProp,
    ...rest
  }: PopoverTriggerElementProps): react_jsx_runtime54.JSX.Element;
  displayName: string;
};
...
declare const PopoverPortal: {
  ({
    ...
    children,
    ...rest
  }: PopoverPortalAtomProps): react_jsx_runtime54.JSX.Element | null;
  displayName: string;
};
...
declare const PopoverPositioner: {
  ({
    ...
    sideOffset,
    ...rest
  }: PopoverPositionerAtomProps): react_jsx_runtime54.JSX.Element;
  displayName: string;
};
...
declare const PopoverPopup: {
  ({
    className,
    ...rest
  }: PopoverPopupAtomProps): react_jsx_runtime54.JSX.Element;
  displayName: string;
};
...
declare const PopoverArrow: {
  ({
    ...
    children,
    ...rest
  }: PopoverArrowAtomProps): react_jsx_runtime54.JSX.Element;
  displayName: string;
};
...
declare const PopoverViewport: {
  ({
    className,
    ...rest
  }: PopoverViewportAtomProps): react_jsx_runtime54.JSX.Element;
  displayName: string;
};
//#endregion
